...
export default function CollegesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto py-12 px-4 bg-white min-h-screen">
      <h1 className="text-4xl font-extrabold text-center mb-10 text-black tracking-tight">Colleges List</h1>
      <div className="flex flex-col gap-10">
        {colleges.map((college) => (
          <div
            key={college._id}
            className="relative bg-white border border-gray-200 rounded-xl overflow-hidden shadow-md flex flex-col md:flex-row transition-transform hover:-translate-y-1 group"
          >
